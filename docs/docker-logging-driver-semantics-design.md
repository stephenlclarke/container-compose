...
| Item | Value |
| --- | --- |
| Status | Implementation in progress; the journald codec/provider contract, generation-fenced shared-sandbox transport, and bounded reconnect-safe client/server wire are implemented, but the production Linux workload and journal backend are not; plugin hosting, Engine integration, handoff, and release evidence remain |
...
| Local Container development head | `c71327abfe67ff12a427dd426af69bb190e2c2fd` (`887848ed719a05836d2f846b69a22749e61f2f62` journald provider; `20071d97d10b386c2a24c84c51bca0e37c0280aa` shared-service transport; `a42ecf2fe1ffa582e34cfa74f6cf1ddba8505368` journald client wire; `bed5de1686bc005ad77ab63025a5582f37601738` journald wire server) |
