...
| Item | Value |
| --- | --- |
| Status | Implementation in progress; the complete local production journald path now includes verified OCI materialization, shared-sandbox supervision, exact routing, readiness withdrawal, durable recovery, and terminal reclamation; release trust/dependency publication, plugin hosting, remaining Engine/gateway integration, devcontainer handoff, and paired release evidence remain |
...
| Local Container development head | `16007b38439cb15d6b7f3fcd24665cd8c07d64b4` (`84d160671f3ba6c265a02b49b2ff4309f6584d30` production journald supervision/reclamation; `887848ed719a05836d2f846b69a22749e61f2f62` journald provider; `20071d97d10b386c2a24c84c51bca0e37c0280aa` shared-service transport; `a42ecf2fe1ffa582e34cfa74f6cf1ddba8505368` journald client wire; `bed5de1686bc005ad77ab63025a5582f37601738` journald wire server; `79c89babc7399c0cc1d4f800bd5ec092cc6c153d` durable backend; `dcefedba2b3b5806953c32e35ca2edaea24658a0` reader checkpoint recovery; `e8cc75f001d24896144a5e44e33d1f7a5d1e5729` Linux workload/systemd adapter) |
