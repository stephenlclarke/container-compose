...
- Retain fail-closed behavior for detached, dirty, or divergent sibling checkouts.
...
- Detached, dirty, and divergent checkout regressions continue to fail closed.
