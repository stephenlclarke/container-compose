...
The exact measured stack came from merged support-fork pull requests
[Containerization #37](https://github.com/stephenlclarke/containerization/pull/37),
[builder-shim #12](https://github.com/stephenlclarke/container-builder-shim/pull/12),
and [Container #142](https://github.com/stephenlclarke/container/pull/142),
then entered Compose through [pull request #325](https://github.com/stephenlclarke/container-compose/pull/325).

No commit measured by this benchmark has a submitted Apple upstream pull
request as of 28 August 2026. The corresponding stock-Apple `upstream/pr-*`
branches remain local candidates and must not be described as submitted PRs.
The [0.14.0 optimization provenance audit](../APPLE-UPSTREAM-REVIEW.md#0140-optimization-pull-request-provenance)
lists the complete merged support-fork chain and current Apple-submission
status.
