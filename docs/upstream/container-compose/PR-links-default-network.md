...
- Updated `DOCKER-COMPOSE-PARITY.md`, `PLAN.md`, and `STATUS.md` to describe implicit default-network links as part of the supported single-network subset.
...
make check
make coverage-check
markdownlint --disable MD013 MD041 -- DOCKER-COMPOSE-PARITY.md PLAN.md STATUS.md docs/upstream/container-compose/ISSUE-links-default-network.md docs/upstream/container-compose/PR-links-default-network.md
git diff --check
```
