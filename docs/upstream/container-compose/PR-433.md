# Pull request 433: align up-menu parity with retained exit-control containers

## Purpose

Pull request [`#433`](https://github.com/stephenlclarke/container-compose/pull/433) aligns the Docker Compose up-menu parity contract with the existing stop-and-retain exit-control lifecycle. This corrects the test oracle that halted the stable 0.14.1 release at parity contract 56.
