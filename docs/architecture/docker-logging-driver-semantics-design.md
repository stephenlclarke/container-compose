...
| Stable release | [`container-compose` 0.14.1](https://github.com/stephenlclarke/container-compose/releases/tag/0.14.1); the 0.14.2 graph is a Current candidate until its Stable Release Gate passes |
| Public-build Container revision | `1f2e4309f4be3f875c5dc8ee1a07182c0e836a0e` |
| Compose checkpoints | The 0.14.2 source is the reviewed Current candidate; earlier signed checkpoints below retain the implementation and oracle history that led to this candidate |
...
| Matched Containerization checkpoints | 0.14.2 candidate revision `e97e92bf3b7c86c569b34b31f5655c0571979f8f`; earlier validation checkpoints remain recorded below |
...
| Last documentation review | 4 September 2026 against the 0.14.2 Current candidate graph |
...
The current 0.14.2 candidate requires
