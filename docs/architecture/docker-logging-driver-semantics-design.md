...
| Stable release | [`container-compose` 0.14.0](https://github.com/stephenlclarke/container-compose/releases/tag/0.14.0), published 28 August 2026 after the hosted Stable Release Gate passed |
...
| Last documentation review | 28 August 2026 against the 0.14.0 immutable release graph |
