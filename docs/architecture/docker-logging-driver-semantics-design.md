...
| Stable release | [`container-compose` 0.14.0](https://github.com/stephenlclarke/container-compose/releases/tag/0.14.0), published 29 August 2026 after the hosted Stable Release Gate passed |
| Public-build Container revision | `e4349d93442e19ca80c0a21356f41c6edacee392` |
...
| Matched Containerization checkpoints | Stable 0.14.0 revision `59ce8dafa11841f47287e3c29d1e8fe6d976236c`; earlier validation checkpoints remain recorded below |
...
| Last documentation review | 29 August 2026 against the 0.14.0 immutable release graph |
