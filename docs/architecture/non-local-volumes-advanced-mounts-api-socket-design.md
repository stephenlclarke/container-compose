...
| Devcontainer | Current source `main` at `f2068a483afc8601575334cc74f61c6097377246` resolves Engine API `84830606abf971110071248e087a80ff4abb86d4`, Container `228897171d71975988ccdc690f1982e7433952af`, Containerization `b404e03bb914904107a6a9305ba1f0e44c79a59c`, and SwiftNIO SSL `3e13ce5f6dd5b7e89fff9ab55ab7caed39fe7285` from Stephen-owned URLs. It uses the shared router/provider-session contracts and carries the logging handoff implementation, while its bounded provider still owns separate state and deliberately omits unsupported routes. Stable 1.0.1 remains the release authority until the newer source graph completes a fresh runtime-parity certification. | Engine API dependency adoption and the earlier C04 functional blocker are closed. Enhanced-authority cutover, image push/auth/build sessions, complete external-client and real-VS-Code evidence, and the typed guest socket-grant lifecycle remain before `use_api_socket`; the in-progress source-parity rerun is not release evidence. |
