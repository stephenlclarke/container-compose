...
| `release-VERSION-TAG` | Permanent copy of a release tag, for example `release-v0.3.0`. | Release package validation only; no debug binaries. |
...
| `container-compose` | `container-compose` | `container-compose-release`, `container-compose-release-v0-3-0`, and other branch-derived formula names |
...
`release-v0.3.0`, keep their own branch-derived Homebrew tags and formula names
...
`release-v0.3.0` becomes `container-compose-release-v0-3-0`.
