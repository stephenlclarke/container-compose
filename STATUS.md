...
- Continue the lifecycle/network topic with remaining job-mode, external config/secret-store, multi-network DNS/alias behavior, shared alias gaps, or move to the next highest-value Compose surface that has matching fork/runtime primitives.
