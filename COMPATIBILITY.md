...
| Present but blocked by `container-compose` design gaps | `exec --index` values other than `1`, `cp --index` values other than `1`, `export --index` values other than `1`, `watch`, `scale`, `attach`, `commit`, `publish` |
