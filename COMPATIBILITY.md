...
3. <img alt="FORK MERGE" src="https://img.shields.io/badge/FORK%20MERGE-2563EB?style=flat-square"> Continue testing static `extra_hosts`, explicit host entries, explicit hostnames, single-network aliases, sticky IPs, DNS defaults, `host-gateway`, and one chosen bridge-networking direction together before exposing more networking fields in `container-compose`.
