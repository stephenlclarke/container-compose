...
- **Host entries, DNS, and network identity:** <img alt="FORK MERGE" src="https://img.shields.io/badge/FORK%20MERGE-2563EB?style=flat-square"> [apple/container#1563](https://github.com/apple/container/pull/1563) and [apple/container#1340](https://github.com/apple/container/pull/1340) directly map to Compose `extra_hosts`; the local fork now combines those directions through `ISSUE-host-entries.md` / `PR-host-entries.md`, and `container-compose` maps static IP-literal `extra_hosts` through `ISSUE-extra-hosts.md` / `PR-extra-hosts.md`. The fork also resolves Docker `host-gateway` through `ISSUE-host-gateway.md` / `PR-host-gateway.md`, and adds explicit `--hostname` support through `ISSUE-hostname.md` / `PR-hostname.md`, with Compose mapping tracked in `ISSUE-service-hostname.md` / `PR-service-hostname.md`. [apple/container#1740](https://github.com/apple/container/pull/1740) helps deterministic address behavior across stop/start. [apple/container#1614](https://github.com/apple/container/pull/1614) helps service DNS configuration. [apple/container#1463](https://github.com/apple/container/pull/1463), [apple/container#1622](https://github.com/apple/container/pull/1622), and [apple/container#1661](https://github.com/apple/container/pull/1661) are competing or complementary bridge-networking directions; test only one coherent bridge direction in the fork after comparing API shape.
