...
def render_registry(payload: dict[str, object]) -> str:
    ...
    lines = [
        ...
        "Do not edit by hand. -->",
        "",
        "This registry is the authoritative current lifecycle status for "
        "upstream handoffs.",
        "Supporting issue and pull-request records preserve their "
        "implementation-time evidence unless",
        "they contain an explicit closure section; every retired document "
