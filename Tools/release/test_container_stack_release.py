...
class ContainerStackReleasePolicyTests(unittest.TestCase):
    ...
    def test_current_build_records_and_publishes_the_matched_vhs_demo(self) -> None:
        ...
        self.assertIn(" -eq 15", workflow)
        self.assertIn("Upload current demo transcript", workflow)
        ...
        self.assertIn("starts() { grep -E 'Starting (alertmanager|cadvisor|grafana|loki|nginx|prometheus|pushgateway|tempo)$'", tape)
        self.assertIn("Set TypingSpeed 1ms", tape)
        self.assertIn("headlog 02-first-up.log", tape)
        self.assertIn("starts 02-first-up.log", tape)
        self.assertIn("taillog 02-first-up.log", tape)
        self.assertIn("marker 02-first-up.log", tape)
        self.assertIn("replay 06-write-volume-marker.log", tape)
        self.assertIn("replay 08-retained-volumes.log", tape)
        self.assertIn("replay 09-second-up.log", tape)
        self.assertNotIn("headlog 09-second-up.log", tape)
        self.assertNotIn("starts 09-second-up.log", tape)
        self.assertNotIn("taillog 09-second-up.log", tape)
        self.assertIn("replay 13-verify-volume-marker.log", tape)
        self.assertIn("replay 14-final-down.log", tape)
        self.assertIn("TAPE_TRANSCRIPT_FIRST_UP_OK", tape)
        self.assertIn("TAPE_TRANSCRIPT_VOLUME_MARKER_WRITTEN_OK", tape)
        self.assertIn("TAPE_TRANSCRIPT_VOLUMES_RETAINED_OK", tape)
        self.assertIn("TAPE_TRANSCRIPT_SECOND_UP_OK", tape)
        self.assertIn("TAPE_TRANSCRIPT_VOLUME_MARKER_REUSED_OK", tape)
