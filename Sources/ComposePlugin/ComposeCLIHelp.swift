...
enum ComposeCLIHelp {
    ...
    private static let supportDetailByCommand: [String: String] = [
        ...
        "commit": "Stopped service containers can be committed to images; --pause has no effect on stopped containers, and running-container commit, including --pause=false, waits for Apple live export/commit support.",
    ]
    ...
    private static let commandHelp: [String: String] = [
        ...
        Options:
          ...
          -p, --pause            Pause a running container during commit (default true; requires Apple live export/commit support).
        """,
        "config": """
