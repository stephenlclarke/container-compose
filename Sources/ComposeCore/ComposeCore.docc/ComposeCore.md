...
@Metadata {
  @PageImage(purpose: icon, source: "container-compose-icon-octopus-outline-fixed.png", alt: "The container-compose application icon: a light-blue octopus in front of a container service panel.")
...
@Image(source: "container-compose-icon-octopus-outline-fixed.png", alt: "The container-compose application icon: a light-blue octopus in front of a container service panel.")
